 ...
 */
class getCondidateRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CondidateRepository' shared autowired service.
     *
     * @return \App\Repository\CondidateRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CondidateRepository.php';

        return $container->privates['App\\Repository\\CondidateRepository'] = new \App\Repository\CondidateRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
